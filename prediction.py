...
from engine import concatenate_dataset
...
def get_args_parser():
    ...
    parser.add_argument('--resume', 
                        default='/home/syliu/home/code/Conditional-RNN-fusion/results/models/SODFormer/train/SODFormer_49.pth', 
...
def main(args):
    ...
    base_ds_val = utils.target_to_coco_format(data_loader_test, args.categories_path)
    evaluate(model, criterion, postprocessors, base_ds_val, data_loader_test, device, model_type, input_type)
