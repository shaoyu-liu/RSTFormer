...
def get_args_parser():
    ...
    # Setupdataset_val = concatenate_dataset(image_set='val', args=args)
    parser.add_argument('--lr', default=2.2e-4, type=float)
    ...
    parser.add_argument('--no_temporal', default=True, action='store_true',
    ...
    parser.add_argument('--dsconv', default=[4, 2, 1, 1],
                        help='down-conv')
    parser.add_argument('--stage_dim', default=[32, 64, 128, 256])
    ...
    #                     default='/home/syliu/home/code/Conditional-RNN-fusion/results/models/SODFormer/train/SODFormer_08.pth',
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and utils.is_main_process():
            with (output_dir / args.exp_method / 'train' / "condition-detr-train.txt").open("a") as f:
